...
func ExchangeToken(ctx context.Context, endpoint string, request *TokenExchangeRequest, headers http.Header, options map[string]interface{}) (*Response, error) {
	data := url.Values{}
	...
	return makeRequest(ctx, endpoint, data, headers)
}

func makeRequest(ctx context.Context, endpoint string, data url.Values, headers http.Header) (*Response, error) {
	if headers == nil {
